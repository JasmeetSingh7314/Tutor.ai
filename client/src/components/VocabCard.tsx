...
const MiniCard = ({
  ...
  <motion.div
    ...
    className={cn(
      "absolute backdrop-blur-lg bg-card/30 border border-border/50 rounded-lg shadow-lg",
      className
    )}
  >
    {children}
  ...
  return (
    <div className={cn("relative min-h-[calc(100vh-8rem)]", className)}>
      ...
      <Button
        ...
        size="lg"
        onClick={onPrevious}
        className="fixed left-4 top-1/2 -translate-y-1/2 rounded-full h-12 w-12 z-20"
      >
        <ChevronLeft className="h-8 w-8  text-[#000] text-[20px]" />
      </Button>
      <Button
        variant="default"
        size="lg"
        onClick={onNext}
        className="fixed right-4 top-1/2 -translate-y-1/2 rounded-full h-12 w-12 z-20"
      >
        <ChevronRight className="h-16 w-16  text-[#00BCFF] " />
      </Button>

      {/* Main Card */}
      <Card className="relative w-full min-h-[800px] backdrop-blur-xl bg-card/40 border-border/50 overflow-hidden p-8">
        ...
        <div className="relative h-[600px]">
          ...
          <MiniCard className="top-0 left-8 w-[280px] p-6">
          ...
          <MiniCard className="top-0 left-1/2 -translate-x-1/2 w-[300px] p-6">
            <div className="flex items-center gap-2 mb-4">
          ...
          <MiniCard className="top-0 right-8 w-[280px] p-6">
            <div className="flex items-center gap-2 mb-4">
          ...
          <MiniCard className="bottom-0 left-8 w-[300px] p-6">
            <div className="flex items-center gap-2 mb-4">
          ...
          <MiniCard className="bottom-0 left-1/2 -translate-x-1/2 w-[280px] p-6">
            <div className="flex items-center gap-2 mb-4">
          ...
          <MiniCard className="bottom-0 right-8 w-[300px] p-6">
            <div className="flex items-center gap-2 mb-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="p-3 rounded-lg bg-secondary/30">
                ...
                <p className="text-sm">{word.formal_vs_informal.informal}</p>
              </div>
            </div>
          </MiniCard>
        </div>
